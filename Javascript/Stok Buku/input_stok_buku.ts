function daftar_buku(){
    var id_buku = (<HTMLInputElement>document.getElementById("txt_id_buku"));
    var judul_buku = (<HTMLInputElement>document.getElementById("txt_judul_buku"));
    var pengarang = (<HTMLInputElement>document.getElementById("txt_pengarang"));
    var penerbit = (<HTMLInputElement>document.getElementById("txt_penerbit"));
    var tahun_terbit = (<HTMLInputElement>document.getElementById("txt_tahun_terbit"));
    var stok_buku = (<HTMLInputElement>document.getElementById("txt_stok_buku"));
